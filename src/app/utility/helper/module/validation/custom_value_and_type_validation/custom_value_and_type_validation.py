...
def validate_if_value_is_empty(value: str, value_name_to_be_validated_on: str) -> None:
    ...
    if not value.strip():
        raise ValueError(f"Please note that {value_name_to_be_validated_on} cannot be empty.")

def validate_if_type_does_not_match(given_type: str, supported_types: Tuple[str, ...]) -> None:
